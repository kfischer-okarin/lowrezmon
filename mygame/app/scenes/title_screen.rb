module Scenes
  class TitleScreen
    ...
    def render(screen, state)
      ...
      if @state == :waiting_for_button
        if state.tick_count % 60 < 30
          screen.primitives << @font.build_label(text: 'Press SPACE', x: 32, y: 2, alignment_enum: 1, r: 255, g: 255, b: 255)
        end
      end
    ...
    def title_bottom_appears_tick(_args, element)
      ...
      @bg_color = Palette::TITLE_COLOR
      @bg_dither_color = Palette::TITLE_COLOR
    end
