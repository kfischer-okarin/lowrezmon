module Scenes
  class Lose
    ...
    def render(screen, state)
      ...
      screen.primitives << {x: 16, y:24, w: 32, h: 32, path: "sprites/cup.png", **Palette::DARK_GREY}.sprite!
      screen.primitives << {x: 14, y:22, w: 40, h: 40, path: "sprites/cross.png"}.sprite!
      screen.primitives << @font.build_label(text: "You, LOSER!", x: 32, y: 14, alignment_enum: 1, **Palette::WHITE)
